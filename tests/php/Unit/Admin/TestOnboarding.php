...
class TestOnboarding extends \WP_UnitTestCase {
	 ...
	 * Test register_hooks.
	 *
	 * @covers \Coywolf\CustomBlocks\Admin\Onboarding::register_hooks()
	 */
	 ...
	 *
	 * @covers \Coywolf\CustomBlocks\Admin\Onboarding::show_welcome_notice()
	 */
	...
	public function test_show_welcome_notice_should_display() {
		$post_id = $this->factory()->post->create( [ 'post_type' => 'coywolf_custom_block' ] );
		update_option(
	 ...
	 *
	 * @covers \Coywolf\CustomBlocks\Admin\Onboarding::plugin_activation()
	 */
	public function test_plugin_activation() {
		$this->instance->plugin_activation();
		$this->assertTrue( is_int( get_option( 'coywolf_custom_blocks_example_post_id' ) ) );
		$this->assertEquals( 'true', get_transient( 'coywolf_custom_blocks_show_welcome' ) );
	}
}
