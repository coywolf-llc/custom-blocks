 ...
 *     @type string   $icon     The block icon, in the format "{libKey}/{ComponentName}" — e.g. 'lu/LuSquareCode', 'bi/BiBox', 'fa6/Fa6Heart', 'hi2/HiHome'. Library keys are the react-icons subpackage names (lu, bi, fa, fa6, hi, hi2, md, pi, ri, tb, etc.); component names are the literal react-icons named exports. See https://react-icons.github.io/react-icons/ for the full catalog. Default: 'lu/LuSquareCode' — the Lucide square-code glyph, eagerly bundled and used as the universal fallback when a stored slug doesn't resolve.
